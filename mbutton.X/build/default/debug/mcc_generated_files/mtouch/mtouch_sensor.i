...
# 55 "mcc_generated_files/mtouch/../tmr2.h"
# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\include\\c99\\stdbool.h" 1 3
# 55 "mcc_generated_files/mtouch/../tmr2.h" 2
...
# 54 "mcc_generated_files/mtouch/mtouch_sensor.c"
...
static mtouch_sensor_sampleperiod_t sample_period = ((mtouch_sensor_sampleperiod_t)200);
...
mtouch_sensor_t mtouch_sensor[1] ={
    {Sensor_AN5,MTOUCH_CVD_ScanA_0,MTOUCH_CVD_ScanB_0, 32,0,0,0,0},
};
# 112 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_InitializeAll(void)
{
    WPUCbits.WPUC1 = 0;
    ANSELCbits.ANSC1 = 0;
...
# 143 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_SampleAll(void)
{
    Sensor_Service(0);
}
...
static enum mtouch_sensor_error Sensor_Acquisition(mtouch_sensor_t* sensor)
{
    ...
    if((mtouch_sensor_packetsample_t)abs(packet_sample - sensor->rawSample) > (mtouch_sensor_packetsample_t)(sensor->oversampling)<<2)
    {
...
static enum mtouch_sensor_error Sensor_Acq_ExecutePacket(mtouch_sensor_t* sensor)
{
    ...
    TMR2_SetInterruptHandler(Sensor_Acq_ExecuteScan);
...
# 285 "mcc_generated_files/mtouch/mtouch_sensor.c"
static void Sensor_Acq_ExecuteScan(void)
{
...
#pragma switch time
 switch(packet_counter & 0x01)
        {
            case 0: MTOUCH_CVD_ScanA_0();break;
            case 1: MTOUCH_CVD_ScanB_0();break;
            default: break;
        }
        ...
        if(packet_counter!=mtouch_sensor[currentScannSensor].oversampling)
        {
            ...
            {
                result = ((mtouch_sensor_adcsample_t)1024) - result;
...
# 335 "mcc_generated_files/mtouch/mtouch_sensor.c"
static enum mtouch_sensor_error Sensor_Scanfrequency_Evaluation(mtouch_sensor_t* sensor)
{
    uint8_t i;
    ...
    for(i=(uint8_t)0;i<(uint8_t)5;i++)
    {
        ...
        if(sample_period > ((mtouch_sensor_sampleperiod_t)255))
        {
            ...
            sample_period+=((mtouch_sensor_sampleperiod_t)200);
        }
        else if(sample_period < ((mtouch_sensor_sampleperiod_t)200))
        {
            sample_period += ((mtouch_sensor_sampleperiod_t)200);
        }
...
# 439 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Disable(enum mtouch_sensor_names sensor)
{
...
# 468 "mcc_generated_files/mtouch/mtouch_sensor.c"
static __attribute__((inline)) void Sensor_setActive(mtouch_sensor_t* sensor)
{
    sensor->acitve = 1;
}
...
_Bool MTOUCH_Sensor_isActive(enum mtouch_sensor_names sensor)
{
        return (_Bool)mtouch_sensor[sensor].acitve;
...
# 504 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Sampled_ResetAll(void)
{
        Sensor_Sampled_Reset(&mtouch_sensor[0]);
}
