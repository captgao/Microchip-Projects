...
__attribute__((inline)) void TMR2_init(void);
__attribute__((inline)) void PWM_init(void);
__attribute__((inline)) void PORT_init(void);
__attribute__((inline)) void CMP1_init(void);
__attribute__((inline)) void ADC_init(void);
