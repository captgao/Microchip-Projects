...
static mtouch_sensor_t mtouch_sensor[1] ={
...
# 205 "mcc_generated_files/mtouch/mtouch_sensor.c"
_Bool MTOUCH_Sensor_SampleAll(void)
{
    enum mtouch_sensor_names sensor;
    for (sensor = 0; sensor < 1; sensor++)
...
# 305 "mcc_generated_files/mtouch/mtouch_sensor.c"
...
# 359 "mcc_generated_files/mtouch/mtouch_sensor.c"
static void Sensor_Acq_ExecuteScan(void)
{
...
# 409 "mcc_generated_files/mtouch/mtouch_sensor.c"
static enum mtouch_sensor_error Sensor_Scanfrequency_Evaluation(mtouch_sensor_t* sensor)
{
    uint8_t i;
...
# 557 "mcc_generated_files/mtouch/mtouch_sensor.c"
static __attribute__((inline)) void Sensor_setActive(mtouch_sensor_t* sensor)
{
    sensor->acitve = 1;
}
...
# 576 "mcc_generated_files/mtouch/mtouch_sensor.c"
_Bool MTOUCH_Sensor_isCalibrated(enum mtouch_sensor_names sensor)
{
...
# 594 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Sampled_ResetAll(void)
{
    mtouch_sensor_t* sensor;
    for(sensor = &mtouch_sensor[0];sensor<= &mtouch_sensor[1 -1];sensor++)
    {
