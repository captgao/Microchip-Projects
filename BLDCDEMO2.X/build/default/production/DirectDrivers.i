...
# 58 "DirectDrivers.c" 2
# 1 "./EBM_Motor.h" 1
# 59 "DirectDrivers.c" 2
# 1 "./1937_DRIVER.h" 1
# 60 "DirectDrivers.c" 2
 ...
 void set_cmp(unsigned char state) {
    switch (state) {
        case(1):
        {
            ...
            CM1CON1=0b10000000 | 0b00000000 | 0b00000010;
            rising_bemf_flag = 0;
            break;
        }
        case(2):
        {
            ...
            CM1CON1=0b10000000 | 0b00000000 | 0b00000001;
            rising_bemf_flag = 1;
            break;
        }
        case(3):
        {
            ...
            CM1CON1=0b10000000 | 0b00000000 | 0b00000000;
            rising_bemf_flag = 0;
            break;
        }
        case(4):
