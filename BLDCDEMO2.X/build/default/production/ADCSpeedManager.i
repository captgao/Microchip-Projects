...
# 2 "<built-in>" 2
# 1 "ADCSpeedManager.c" 2
# 67 "ADCSpeedManager.c"
...
# 69 "ADCSpeedManager.c" 2
# 1 "./EBM_Motor.h" 1
# 70 "ADCSpeedManager.c" 2
# 1 "./1937_DRIVER.h" 1
# 71 "ADCSpeedManager.c" 2
...
void SpeedManager(void)
{
 ...
 if(!TMR0_duty_flag) return;

 TMR0_duty_flag=0;
 if(--TMR0_duty_timer) return;
 ...
 if(sravg < ((255*15)/100))
 {
    if(run_flag) stop_flag = 1;
    run_flag = 0;
    return;
   }

   if(sravg > ((255*25)/100)) run_flag = 1;
