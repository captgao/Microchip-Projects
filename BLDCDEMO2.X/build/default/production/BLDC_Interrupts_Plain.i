...
# 2 "<built-in>" 2
# 1 "BLDC_Interrupts_Plain.c" 2
# 55 "BLDC_Interrupts_Plain.c"
...
# 57 "BLDC_Interrupts_Plain.c" 2
# 1 "./EBM_Motor.h" 1
# 58 "BLDC_Interrupts_Plain.c" 2
# 1 "./1937_DRIVER.h" 1
# 59 "BLDC_Interrupts_Plain.c" 2
...
# 167 "BLDC_Interrupts_Plain.c"
            ...
            {
# 225 "BLDC_Interrupts_Plain.c"
               expected_zc.word = (TMR1_comm_time.word>>1) | 0x8000;

               zc.word += CommOffset;

               zc_error = zc.word - expected_zc.word;
               temp = zc_error;
               ...
               TMR1_comm_time.word -= (zc_error>>3);
               comm_after_zc.word = TMR1_comm_time.word + (0L - 0L*(((32000000L/4L)/8L)/1000000L));
